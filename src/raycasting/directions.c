...
/*   Updated: 2024/01/17 11:49:57 by jcario           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if(game->map.map[(int)(game->rc.pos.x + game->rc.plane.x * MOVE_SPEED / 2)][(int)game->rc.pos.y] != '1')
		game->rc.pos.x += game->rc.plane.x * MOVE_SPEED / 2;
	if(game->map.map[(int)game->rc.pos.x][(int)(game->rc.pos.y + game->rc.plane.y * MOVE_SPEED / 2)] != '1')
